...
- Divisible-by constraint (useful for latent models like LTX-2.3 / SDXL workflows, where other nodes only do one side.) Disable maintain aspect ratio as this function is optional.
